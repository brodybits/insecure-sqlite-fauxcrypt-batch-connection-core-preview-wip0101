...
- Background threading would need to be done in a higher-level component, which should be straightfowrard on both Android and iOS, as is now demonstrated in the Cordova plugin demo.
