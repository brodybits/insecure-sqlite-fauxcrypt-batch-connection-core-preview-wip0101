...
Demonstrates accessing database files with an encryption key from an Apache Cordova application, with help from the `cordova-sqlite-storage-file` and `cordova-plugin-file` plugins.
