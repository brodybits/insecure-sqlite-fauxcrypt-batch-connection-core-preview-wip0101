...
jnilib: $(SQLITE_AMALGAMATION)/sqlite3.c
	...
	cc $(JNI_C_SOURCE) -o $(JNI_LIB_FILE) -shared $(CRYPTO_CC_FLAGS) -I`$(GET_MAC_JAVA_HOME)`/include -I`$(GET_MAC_JAVA_HOME)`/include/darwin -I$(SQLITE_AMALGAMATION) -I$(SCCLIB_SOURCE_DIR)
