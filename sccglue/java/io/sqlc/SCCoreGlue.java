...
public class SCCoreGlue {
  ...
  /** Interface to C language function: <br> <code> int scc_open_connection(const char *  full_name, int flags); </code>    */
  public static native int scc_open_connection(String full_name, int flags);
