...
public class SCCoreGlue {
  ...
  /** Interface to C language function: <br> <code> const char *  scc_get_column_long_as_text(int connection_id, int column); </code>    */
  public static native String scc_get_column_long_as_text(int connection_id, int column);
