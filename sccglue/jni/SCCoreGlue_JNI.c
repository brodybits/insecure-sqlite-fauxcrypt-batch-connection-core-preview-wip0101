/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/JavaEmitter.java on Wed Apr 22 16:15:12 EDT 2020 ----! */
...
/*   Java->C glue code:
 *   Java package: io.sqlc.SCCoreGlue
 *    Java method: java.lang.String scc_get_column_long_as_text(int connection_id, int column)
 *     C function: const char *  scc_get_column_long_as_text(int connection_id, int column);
 */
JNIEXPORT jstring JNICALL
Java_io_sqlc_SCCoreGlue_scc_1get_1column_1long_1as_1text__II(JNIEnv *env, jclass _unused, jint connection_id, jint column) {
  const char *  _res;
  _res = scc_get_column_long_as_text((int) connection_id, (int) column);
